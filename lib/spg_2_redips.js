...
/** Returns the column number (starting from 0) of a given student, based on his/her 'hall_position' property
* ie:  "D1", "B6", "C13", "A1", etc   ---would return--->    3, 1, 2, 0, etc
* @param std The student 
* @return The numeric corresponding column value from his/her 'hall_position' property 
*/
...
/** Returns the row number (starting from 0) of a given 'hall_position' (ghp)
* @param ghp The value of the hall_position property of an students (i.e: "D1", "B6", "C13", "A1", etc)
