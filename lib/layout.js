...
//	REDIPS.drag.loadContent(id_table_students, "[[\"d16\", 0, 1, \"\", \"C1\"], [\"d17\", 0, 3, \"\", \"C2\"]]");
	...
	var lettersTable = this.getLettersTable(dimen.height);
	var numbersTable = this.getNumbersTable();
	$('#' + ep.table_letters ).html(lettersTable); 
	$('#' + ep.table_numbers ).html(numbersTable); 
	//A todos los div que crea REDIPs en su loadContent, les ajustamos la dimension
...
Layout.prototype.cellContent = function(std){
	...
	cc += "<div class=\"yui-b\"><div id=\"secondary\"></div> </div> </div>";
	cc += "<div id=\"ft\"> <div id=\"footer\">" + icons + "</div> </div> </div>";
	return cc;
}
