...
//GLOBAL
var url_DDBS_course=""; //content.js will use it for ajax-quering calm server 
...
var regex_VRAY_production = ""; //add others
...
function updateState(url){
	...
	if(enabled){ //URL of a CALM course!
		...
		console.log("background.js: VALID URL: " + url_DDBS_course);
